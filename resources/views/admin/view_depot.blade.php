            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">View Depot </h3> <a href="{{ url('pdfview') }}" target="_blank" class="btn btn-danger"><i class="fa fa-file-pdf-o fa-lg" title="pdf"></i></a>
                  <a href="{{ url('export') }}"  class="btn btn-success"><i class="fa fa-file-excel-o fa-lg" title="excel"></i></a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td>{{ $key->city }}</td>
                        <td>{{ $key->pincode }}</td>
                        <td><a href="{{ url('/edit-depot/'.$key->id) }}"><i class="fa fa-pencil btn btn-warning btn-sm" title="edit"></i></a> | <button type="button"  class="btn btn-danger btn-sm" data-toggle="modal" data-target="#depotDelete_{{ $sr_no }}">
