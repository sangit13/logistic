              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="contact_no1" value="{{ old('contact_no1')}}" placeholder="Enter Contact Number 1">
                      </div> 
                      <small id="emailHelp" class="form-text text-muted">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                          <input type="text" class="form-control" name="contact_no2" value="{{ old('contact_no2')}}" placeholder="Enter Contact Number 2">
                      </div>
                          <small id="emailHelp" class="form-text text-muted">
