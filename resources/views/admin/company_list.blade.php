                    ...
                    <div class="form-group">
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="company_code" value="{{ $comp_list->company_code }}">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="company_name" value="{{ $comp_list->company_name }}" placeholder="Enter Company Name">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="contact_no1" value="{{ $comp_list->contact_no1 }}" placeholder="Enter Contact Numbaer 1" maxlength="10">
                      </div> 
                      <small id="emailHelp" class="form-text text-muted">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                          <input type="text" class="form-control" name="contact_no2" value="{{ $comp_list->contact_no2 }}" placeholder="Enter Contact Numbaer 2" maxlength="10">
                      </div>
                          <small id="emailHelp" class="form-text text-muted">
              ...
              <div class="row">
                 <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="address_one" class="form-control" placeholder="Address 1" value="{{ $comp_list->adres_one }}">
                      <small id="emailHelp" class="form-text text-muted">
                        {!! $errors->first('address_one', '<p class="help-block" style="color:red;">:message</p>') !!}
                      </small>
                      <input type="text" name="address_two" class="form-control" style="margin-top: 2%" placeholder="Address 2" value="{{ $comp_list->adres_two }}">
                      <small id="emailHelp" class="form-text text-muted">
                        {!! $errors->first('address_two', '<p class="help-block" style="color:red;">:message</p>') !!}
                      </small>
                      <input type="text" name="address_three" class="form-control" style="margin-top: 2%" placeholder="Address 3" value="{{ $comp_list->adres_thre }}">
                       <small id="emailHelp" class="form-text text-muted">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="pincode" class="form-control" value="{{ $comp_list->pin_code }}">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
