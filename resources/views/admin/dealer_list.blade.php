...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Master Account</li>
          </ol>
        </section>
    ...
    <div class="row">
               ...
               <div class="row">
                    ...
                    <div class="form-group">
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="account_code" value="{{ $dealer_list->acc_code }}">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-building-o"></i></span>
                          <input type="text" class="form-control" name="account_name" value="{{ $dealer_list->acc_name }}"> 
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
                 ...
                 <div class="col-md-4">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="pincode" class="form-control" value="{{ $dealer_list->pincode }}">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                       ...
                       <input name="country" class="form-control" value="{{ $dealer_list->country }}">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                       ...
                       <input name="city_code" class="form-control" value="{{ $dealer_list->city }}">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
      ...
      <div class="col-sm-2">
        <div class="box-tools pull-right">
          <a href="{{ url('/view-mast-dealer') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Dealer</a>
        </div>
      </div>
