                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="make_model" value="{{ $fleet_list->make_model }}" placeholder="Enter Make Model">
                      </div> 
                      <small id="emailHelp" class="form-text text-muted">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="base_location" value="{{ $fleet_list->base_location }}" placeholder="Enter Base Location">
                      </div>
                          <small id="emailHelp" class="form-text text-muted">
