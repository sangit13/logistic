                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td>{{ $key->contact_no1 }}</td>
                        <td>{{ $key->contact_no2 }}</td>
                        <td>{{ $key->fax_no }}</td>
                        <td>{{ $key->email_id }}</td>
                        <td>{{ $key->adres_one }},{{ $key->adres_two }},{{ $key->adres_thre }} - {{ $key->pin_code }}</td>
                        ...
                        <td><a href="{{ url('/edit-company/'.$key->id) }}"><i class="fa fa-pencil btn btn-warning btn-sm" title="edit"></i></a> | <button type="button"  class="btn btn-danger btn-sm" data-toggle="modal" data-target="#comapnyDelete_{{ $sr_no }}">
