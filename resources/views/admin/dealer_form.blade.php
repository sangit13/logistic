              ...
              <div class="row">
                 <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="address_one" placeholder="Enter Address 1">
                      <small id="emailHelp" class="form-text text-muted">
                        {!! $errors->first('address_one', '<p class="help-block" style="color:red;">:message</p>') !!}
                      </small>
                      <input type="text" name="address_two" placeholder="Enter Address 2" class="form-control" style="margin-top: 2%">

                        <small id="emailHelp" class="form-text text-muted">
                        {!! $errors->first('address_two', '<p class="help-block" style="color:red;">:message</p>') !!}
                      </small>

                      <input type="text" class="form-control" name="address_three" placeholder="Enter Address 3" style="margin-top: 2%">
                        <small id="emailHelp" class="form-text text-muted">
