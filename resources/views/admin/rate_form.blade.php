    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        <div class="box box-primary Custom-Box">
            <div class="box-header with-border" style="text-align: center;">
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Add Rate </h2>
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" name="depot_code">
                            ...
                            <option value="{{ $key->depot_code }}">{{ $key->depot_code }} [{{$key->depot_name}}]</option>
                            @endforeach
                          </select>
                        </div>
                      ...
                      <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-arrow-right"></i></span>
                           <select class="form-control" name="destination_code">
                            ...
                            <option value="{{ $key->code }}">{{ $key->code }} [{{$key->name}}]</option>
                            @endforeach
                          </select>
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
                      ...
                      <label>
                       Rate : 
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="rate" value="{{ old('rate')}}" placeholder="Enter Rate">
                        </div>
                          <small id="emailHelp" class="form-text text-muted">
                      ...
                      <label>
                       Overload : 
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="overload" class="form-control" placeholder="Enter Overload" value="{{ old('overload')}}">
                        </div>
                          <small id="emailHelp" class="form-text text-muted">
      ...
      <div class="col-sm-2">
        <div class="box-tools pull-right">
          <a href="{{ url('/view-mast-rate') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Rate</a>
        </div>
      </div>
