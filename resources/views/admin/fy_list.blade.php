                    ...
                    <div class="form-group">
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="company_code" value="{{ $fy_list->company_code }}" placeholder="Enter Company Code">
                        </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="comapny_name" value="{{ $fy_list->company_name }}" placeholder="Enter Company Name">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
                        {!! $errors->first('comapny_name', '<p class="help-block" style="color:red;">:message</p>') !!}
                      </small>
                    </div>
                    <!-- /.form-group -->
                  </div> 
