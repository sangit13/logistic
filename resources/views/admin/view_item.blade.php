                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td align="center">{{ $key->um }}</td>
                        <td align="center">{{ $key->aum }}</td>
                        
                        <td align="center"><a href="{{ url('/edit-item/'.$key->id) }}"><i class="fa fa-pencil btn btn-warning btn-sm" title="edit"></i></a> | <a onclick="return getId(<?php echo $key->id; ?> )"><i class="fa fa-trash btn btn-danger btn-sm" title="delete"></i></a></td>
