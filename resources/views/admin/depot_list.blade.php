...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Master Depot</li>
          </ol>
        </section>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="contact_no" value="{{$depot_list->contac_person}}" placeholder="Enter Contact Number">
                      </div> 
                      <small id="emailHelp" class="form-text text-muted">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="pincode" class="form-control" value="{{ $depot_list->pincode }}" placeholder="Enter Pincode">
                      </div>
                      <small id="emailHelp" class="form-text text-muted">
                    ...
                    <div class="form-group">
                      ...
                      <select name="state_code" class="form-control">
                       ...
                       @foreach ($state_list as $key)
                        <option value="{{$key->state_code}}" <?php if($key->state_code==$depot_list->state) {echo 'selected';} ?>>{{$key->state_name }}</option>
                        @endforeach
                      </select>
                      <small id="emailHelp" class="form-text text-muted">
